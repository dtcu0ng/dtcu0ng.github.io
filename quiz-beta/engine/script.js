//JS ANSWER QUIZAPP. Powered by CuongZ.
console.log("SCRIPT LOADED!")
console.log("Init for current webapps...")
// Số câu hỏi 
var numQues = 40;
...
console.log("Init done. (c) CuongZ.")
//Dịch ngược đỉnh cao đấy :D ENJOY VỚI ĐÁP ÁN MÀ BẠN TÌM ĐƯỢC :D
