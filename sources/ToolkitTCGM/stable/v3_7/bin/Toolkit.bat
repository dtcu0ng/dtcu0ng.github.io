color 3f
title Toolkit for Tencent Gaming Buddy - Version 3.7
mode 130,30
cls
@echo off
...
echo Build date: 22/07/2019 9:06AM
echo Source: https://github.com/CuongZ/ToolkitTCGM_OfficialBuild
echo -------------------------------------------------------------------------------
echo (c) Made by CuongZ. Version 3.7
echo Github : https://github.com/CuongZ
echo Facebook : https://facebook.com/dtcuog
